...
@Component({
  selector: 'app-khach-hang-phan-hoi',
  templateUrl: './khach-hang-phan-hoi.component.html',
  styleUrls: ['./khach-hang-phan-hoi.component.scss'],
})
export class KhachHangPhanHoiComponent {
  @Input() list: any[] = [
    { link: '#a', text: 'Dịch vụ' },
