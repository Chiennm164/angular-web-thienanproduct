  ...
  ngOnInit(): void {
    this.questions = [
      ...
      },
      {
        ...
        hidden:
          ' Thiên An thực hiện 1 dự án sản xuất TVC quảng cáo trong vòng 2 tuần.',
      },
    ];
    ...
    this.banner = {
      ...
      background:
        'https://vietstarmax.vn/wp-content/uploads/2022/06/banner-phim-tvc3.webp',
      colorTextWhite: false,
    };

    this.navigation = [
      { id: 1, text: 'Giới thiệu và lợi ích', url: '#' },
      { id: 2, text: 'Tại sao chọn Thiên An', url: '#' },
      { id: 3, text: 'Quy trình sản xuất', url: '#' },
      { id: 4, text: 'Cam kết dịch vụ', url: '#' },
    ];

    this.gioiThieu = {
      header: {
        iconUrl:
          'https://vietstarmax.vn/wp-content/uploads/2022/06/play-btn-red.webp',
      ...
      content: {
        ...
        desc: [
          ...
          {
            title:
              'Sự hài lòng tuyệt đối của các doanh nghiệp về dịch vụ sản xuất TVC quảng cáo của Thiên An chính là động lực lớn thúc đẩy chúng tôi chuyên nghiệp và sáng tạo không ngừng!',
            desc: '',
          },
          {
            title:
    ...
    this.loiIch = {
      ...
      content: {
        ...
        urlImg:
          'https://vietstarmax.vn/wp-content/uploads/2022/06/tvc-quang-cao-tien-linh-sunhouse.webp',
      },
    };
    ...
    this.dichVu = {
      ...
      content: {
        desc: [
          ...
          'Dựng hậu kỳ phim quảng cáo tại Thiên An',
          'Lồng tiếng, âm thanh, kỹ xảo, 2D, 3D',
          'Final phim hoàn thiện',
        ],
        urlImg:
          'https://vietstarmax.vn/wp-content/uploads/2022/06/san-xuat-tvc-bg.webp',
      },
    };
    ...
    this.taiSao = {
      header: {
        ...
        desc: 'Thị trường phim quảng cáo hiện nay có không ít công ty làm TVC quảng cáo. Song để tìm được một công ty sản xuất phim quảng cáo chuyên nghiệp, nhiều năm kinh nghiệm làm phim quảng cáo trên truyền hình như Thiên An là rất khó.',
      },
      content: {
        left: [
          {
            title:
              'Thiên An là đơn vị DUY NHẤT tại miền Bắc có đủ khả năng xây dựng chiến dịch tổng thể phim quảng cáo TVC, bao gồm:',
            desc: [
      ...
      lienhe: [
        {
          text: 'Đến với dịch vụ sản xuất TVC quảng cáo của Thiên An bạn không chỉ nhận được sản phẩm chất – nhất, mà còn được phục vụ tận tình, tận tâm.',
          textLink: '',
          phone: '',
        },
        {
